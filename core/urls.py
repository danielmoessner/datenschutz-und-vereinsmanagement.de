...
urlpatterns = [
    ...
    path('artikel', views.ArticlesView.as_view(), name='articles_all'),
    # path('dsgvo', views.ArticlesView.as_view(), name='dsgvo'),
    path('artikel/tag/<slug:tag>/', views.ArticlesView.as_view(), name='articles'),
